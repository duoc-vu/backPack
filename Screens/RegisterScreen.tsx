...
const RegisterScreen = ({navigation}:any) => {
    ...
    const onSubmit = () => {
        ...
        axios.post('https://6620a7e23bf790e070b03688.mockapi.io/Account',formData)
        .then((respon)=>{
            if(respon.data)
                Alert.alert(`Cam on ban ${respon.data.email} da dang ki tai khoan`)
        ...
        //     setCheckEmail(true)
        // }
        // formData.password ==='' ?setCheckPass('Chưa nhập mật khẩu'): setCheckPass('');
        ...
        <>
            ...
            <StatusBar backgroundColor={'#ffffff'} barStyle={'dark-content'}></StatusBar>
                ...
                <View style={styles.form}>
                    <View style={styles.group}>
                        <Icon style={styles.icon} name="locked" size={30} color="gray" />
                        <TextInput placeholder='Repassword' style={styles.input} secureTextEntry={true} onChangeText={(value)=>setPassword(value)}></TextInput>
                        <Text style={{color:'red'}}>{errorPass}</Text>
                    </View>
                </View>
                ...
                <TouchableOpacity style={styles.buttons} onPress={()=>onSubmit()}><Text>Dang ki</Text>
                </TouchableOpacity>
